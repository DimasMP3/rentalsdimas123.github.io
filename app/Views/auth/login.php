                ...
                <div class="auth-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center auth-links-footer">
                            <p>Don't have an account? <a href="<?= site_url('register') ?>" class="auth-link">Register</a></p>
                            <p><a href="<?= site_url('forgot-password') ?>" class="auth-link">Forgot Password?</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<style>
   ...
   .custom-alert.alert-success {
    ...
    .custom-form-check .form-check-input:checked {
        background-color: #3B82F6; /* Warna biru saat dicentang */
        border-color: #3B82F6;
    }
