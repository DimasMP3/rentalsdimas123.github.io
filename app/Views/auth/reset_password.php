                ...
                <div class="auth-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('reset-password') ?>" method="post">
                            ...
                            <div class="mb-4">
                                <div class="form-floating">
                                    <input type="password" name="password" id="password" class="form-control custom-input" placeholder="New Password" required>
                        ...
                        <div class="mt-4 text-center auth-links-footer">
                            <p><a href="<?= site_url('login') ?>" class="auth-link">Back to Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
